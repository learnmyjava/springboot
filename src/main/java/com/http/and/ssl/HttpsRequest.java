...
//    private static Log log = new Log(LoggerFactory.getLogger(HttpsRequest.class));
    ...
    private void init() throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        FileInputStream instream = new FileInputStream(new File(""));//加载本地的证书进行https加密传输 Configure.getCertLocalPath()
        try {
            keyStore.load(instream, "".toCharArray());//设置证书密码Configure.getCertPassword()
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore,"".toCharArray())// Configure.getCertPassword()
                .build();
    ...
    public String sendPost(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        //设置根目录的名称，如果不设置，将会是类名，如：<com.tencent.protocol.pay_protocol.ScanPayReqData>
//        xStreamForRequestPostData.alias("xml", ScanPayReqData.class);
