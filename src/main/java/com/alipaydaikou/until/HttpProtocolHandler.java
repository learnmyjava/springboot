...
public class HttpProtocolHandler {
	...
	private static final long defaultHttpConnectionManagerTimeout = 50 * 1000;
	...
	public HttpResponse execute(HttpRequest request, String strParaFileName, String strFilePath)
		...
		System.out.println("请求支付宝的url:"+request.getUrl());
		// get模式且不带上传文件
		...
		try {
			System.out.println("开始执行httpclient···");
			System.out.println(new Date().getTime());
			httpclient.executeMethod(method);
			System.out.println(new Date().getTime());
			System.out.println("end执行httpclient···");
